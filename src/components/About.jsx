        ...
        <div style={{ position: 'relative' }}>
          <div className="glass-card contact-card" style={{ padding: '3rem', position: 'relative', zIndex: 1 }}>
            ...
            <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem', fontSize: '1.1rem', lineHeight: '1.8' }}>
              Halo! Saya <strong>Wilson Eksaudi Sihombing</strong>, lulusan <strong>Sistem Informasi - Institut Teknologi Del</strong>.
            </p>
            ...
            <div style={{ display: 'flex', gap: '3rem', marginTop: '3rem', flexWrap: 'wrap' }}>
              <div>
                <h3 className="text-gradient" style={{ fontSize: '2.5rem' }}>3.79</h3>
              ...
              <div>
                ...
                <span style={{ color: 'var(--text-muted)' }}>Lulus Sarjana (S.Kom.)</span>
              </div>
            </div>
          </div>
        </div>
